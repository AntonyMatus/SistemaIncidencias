...
class RegistrosValidator extends AValidator
{
    ...
    public function __construct()
    {
        $this->messages = [
            ...
            'dirección.required' => 'La direccion es requeida',
            'dirección.max' => 'La dirección es máximo 255 caracteres!',
            'direccion.regex' => 'La dirección no es valida',
        ...
        $this->rules = [
            'create' => [
                ...
                'dirección' => ['required', 'string', 'max:255','regex:/^[.,A-Za-z0-9ÑñÁáÉéÍíÓóÚúÜü\s]+$/'],
