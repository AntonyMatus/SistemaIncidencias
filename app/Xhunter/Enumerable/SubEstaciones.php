...
{
   const SALIDA_DE_CILINDROS_POR_FUGA_DE_GAS = 1;
   ...
   const COMPLEMENTARIAS = 6;

   public static function getAll()
   {
       return [
           self:: SALIDA_DE_CILINDROS_POR_FUGA_DE_GAS => 'SALIDA DE CILINDROS POR FUGA DE GAS',
           ...
           self:: COMPLEMENTARIAS => 'COMPLEMENTARIAS',
       ];
   }
