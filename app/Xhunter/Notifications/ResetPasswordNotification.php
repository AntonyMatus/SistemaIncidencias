...
namespace Xhunter\Notifications;
...
class ResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::getFromJson('Solicutud de reestablecimiento de contraseña'))
            ...
            ->line(Lang::getFromJson('Si no realizaste esta petición, puedes ignorar este correo y nada habra cambiado.'))->salutation('¡Saludos!');
    }
