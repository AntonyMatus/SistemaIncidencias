...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <p id="negritas2">Emito el resumen de las actividades correspondientes del {{$diaini}} al {{$diaout}} del mes {{$mesini}} del presente año</p>
            </div>
            <br>
                <table>
                        <thead>
