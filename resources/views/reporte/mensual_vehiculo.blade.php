                ...
                <table>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-center">{{$mes_veh1}} </td>
                            
                          </tr>
                          <tr>
                            <td class="text-center">B-02</td>
                            <td class="text-center">{{$mes_veh2}} </td>
                            
                          </tr>
                          <tr>
                            <td class="text-center">B-03</td>
                            <td class="text-center">{{$mes_veh3}}</td>
                            
                          </tr>
                          <tr>
                              <td class="text-center">B-04</td>
                              <td class="text-center">{{$mes_veh4}}</td>
                              
                          </tr>
                          <tr>
                                <td class="text-center">B-105</td>
                               <td class="text-center">{{$mes_veh5}}</td>
                               
                          </tr>
                          <tr>
                              <td class="text-center">B-106</td>
                              <td class="text-center">{{$mes_veh6}} </td>
                              
                          </tr>
                          <tr>
                              <td class="text-center">B-108</td>
                              <td class="text-center">{{$mes_veh7}} </td>
                             
                          </tr>
                          <tr>
                              <td class="text-center">B-109</td>
                              <td class="text-center">{{$mes_veh8}} </td>
                              
                          </tr>
                          <tr>
                            <td class="text-center">B-110</td>
                            <td class="text-center">{{$mes_veh9}}</td>
                            
                        </tr>
                        <tr>
                            <td class="text-center">B-111</td>
                            <td class="text-center">{{$mes_veh10}}</td>
                            
                        </tr>
                        <tr>
                            <td class="text-center">B-112</td>
                            <td class="text-center">{{$mes_veh11}} </td>
                            
                        </tr>
                        <tr>
                            <td class="text-center">B-113</td>
                            <td class="text-center">{{$mes_veh12}}</td>
                           
                        </tr>
                        <tr>
                            <td class="text-center">B-114</td>
                            <td class="text-center">{{$mes_veh13}}</td>
                            
                        </tr>
                        <tr>
                            <td class="text-center">B-115</td>
                            <td class="text-center">{{$mes_veh14}} </td>
