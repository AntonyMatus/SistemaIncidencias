...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <!-- Icon -->
    <link rel="stylesheet" href="{{asset('landing-page/assets/fonts/line-icons.css')}}">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="{{asset('landing-page/assets/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('landing-page/assets/css/owl.theme.css')}}">

    <link rel="stylesheet" href="{{asset('landing-page/assets/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('landing-page/assets/css/nivo-lightbox.css')}}">
    <!-- Animate -->
  ...
  <body>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
              <div class="contents">
                <h2 class="head-title">You're Using Free Lite Version of Fusion Template</h2>
                <p>Please purchase full version of the template to get all features and facilities, Please purchase full version of the template to get all features and facilities. Please purchase full version of the template to get all features and facilities</p>
                <div class="header-button">
                  <a rel="nofollow" href="https://rebrand.ly/fusion-ud" class="btn btn-common">Purchase Now</a>
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
              <div class="intro-img">
                <img class="img-fluid" src="{{asset('landing-page/assets/img/intro-mobile.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12 wow fadeInRight" data-wow-delay="0.3s">
            <img class="img-fluid" src="{{asset('landing-page/assets/img/about/img-1.png')}}" alt="" >
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
            <div class="show-box wow fadeInUp" data-wow-delay="0.3s">
              <img src="{{asset('landing-page/assets/img/feature/intro-mobile.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
            ...
            <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{asset('landing-page/assets/img/testimonial/img1.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{asset('landing-page/assets/img/testimonial/img2.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{asset('landing-page/assets/img/testimonial/img3.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{asset('landing-page/assets/img/testimonial/img4.jpg'
                    )}}" alt="">
                  </div>
                  <div class="info">
    ...
    <!-- Call To Action Section Start -->
          ...
          <div class="col-lg-5 col-md-12 col-xs-12">
            <div class="map">
              ...
              data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3754.0876936892028!2d-90.61947558553815!3d19.793878886680073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f8332aa946eb63%3A0x180d43f956e4f0ec!2sInstituto+Tecnol%C3%B3gico+de+Campeche!5e0!3m2!1ses!2smx!4v1560032036655!5m2!1ses!2smx"></object>
            </div>
          </div>
        </div>
      </div> 
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                <h3 class="footer-logo"><img src="{{asset('landing-page/assets/img/logo.png')}}" alt=""></h3>
    ...
    <script src="{{asseT('landing-page/assets/js/wow.js')}}"></script>
    <script src="{{asseT('landing-page/assets/js/jquery.nav.js')}}"></script>
